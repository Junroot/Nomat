...
description: 변경을 만들고 구현에 필요한 모든 아티팩트를 한 번에 생성한다
category: Workflow
tags: [workflow, artifacts, experimental]
---

아티팩트 생성을 빠르게 진행한다 - 구현을 시작하는 데 필요한 모든 것을 생성한다.

**입력**: `/opsx:ff` 뒤의 인자는 변경 이름(kebab-case), 또는 사용자가 만들고 싶은 것에 대한 설명이다.

**단계**

1. **입력이 없으면 무엇을 만들지 물어본다**
...
- 안내: "`/opsx:apply`를 실행하면 구현을 시작합니다."
...
- 같은 이름의 변경이 이미 있으면 그 변경을 이어갈지 새로 만들지 사용자에게 묻는다
